          ...
          >
            <div className='relative inline-block  bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6'>
                ...
                <div className='mt-3 text-center sm:mt-5'>
                  ...
                  <div className='mt-2'>
                    <p className='text-sm text-gray-500'>
                      To view this opportunity, simply create a FREE account and
                      login to access the opportunities and more!
                    </p>
                  </div>
                </div>
              </div>
              <div className='mt-5 sm:mt-6 sm:grid sm:grid-cols-1 sm:gap-3 sm:grid-flow-row-dense'>
                <button
                  type='button'
                  className='w-full mx-auto justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-gray-600 text-base font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:text-sm'
                  onClick={() => (window.location.href = '/signup')}
                >
                  Register Now
                </button>
                <div className='mt-3 mb-3 sm:mt-2 sm:mb-5 text-center'>
