...
const OnboardEmailVerificationCard: React.FC = () => {
  const navigate = useNavigate();
  const { user } = useUserContext();
  const [type = OrganizationType.Buyer, setType] = useState<OrganizationType>();
  ...
  return (
    <div className='main grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8'>
      <div className='main-left lg:px-12 md:px-8 sm:px-4 px-4'>
        ...
        <div className='body'>
          <div className='header'>{user?.firstName}, who are you?</div>
...
export default OnboardEmailVerificationCard;
